...
#define PIN15				1<<15 
////////////////////////////////////////////////////////////////////////////////// 
uint8_t Sys_Clock_HSESet(uint32_t plln,uint32_t pllm,uint32_t pllp,uint32_t pllq);		//系统时钟设置
...
void NVIC_Config(FunctionalState state,uint8_t channel,uint8_t priority);
//以下为汇编函数
